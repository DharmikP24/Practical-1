...
fun main(){
    var l1=Laptop("ACER",2,85000,"8Core","16GB","1024")
    var l2=Laptop("ASUS",5,75000,"8Core","32GB","512")
    var l3=Laptop("HP",4,40000,"8Core","16GB","512")
    var l4=Laptop("Lenovo",9,12000,"8Core","8GB","256")
    var l5=Laptop("DELL",6,43000,"8Core","16GB","256")
}
